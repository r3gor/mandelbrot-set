...
int MAX_ITER = 300;
float move_x = 0.0f, move_y = 0.0f, move_velocidad = 0.15; 
float zoom = 1;
...
void display(GLFWwindow *window, double currentTime){
    ...
    if(ImGui::SliderFloat("Vel. movimiento", &move_velocidad, 1, 3)){
        glUniform1i(glGetUniformLocation(sp, "MAX_ITER"), MAX_ITER);
    }
...
int main(){
    ...
    window = glfwCreateWindow(WIDTH, HEIGHT, "Mandelbrot Set - Shader float", NULL, NULL);
